...
mysql-connector-python: Controlador oficial para conectar Python con el servidor MySQL. -python-dotenv: Gestor de variables de entorno para proteger credenciales sensibles de la base de datos.
...
DB_HOST=localhost DB_USER=tu_usuario_mysql DB_PASSWORD=tu_contraseña_mysql DB_NAME=neo_grid_gaming SECRET_KEY=una_clave_secreta_muy_segura

Historial de Endpoints de la API (Backend)
GET/
